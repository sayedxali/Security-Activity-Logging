...
class AuthenticationServiceImplTest {
    ...
    private @Mock LogUserRepository logUserRepository;
    ...
    public void registerUser_ValidInputs_Success() {
        ...
        LogUser user = new LogUser("1", "user", "user", "USER", false, Instant.now());
        given(this.logUserRepository.save(user))
                .willReturn(user);
        ...
        assertThat(savedUser.userId()).isEqualTo(user.getUserId());
